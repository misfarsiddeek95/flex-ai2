...
export function CaseStudyForm({ initialData, isNew }: CaseStudyFormProps) {
    ...
    const defaultValues: CaseStudyFormData = initialData
        ? {
            ...(initialData as any), // TS cache issue: showInHome exists in schema but not recognized yet
            showInHome: (initialData as any).showInHome ?? false,
            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                ...
                <div className="space-y-8 lg:col-span-2">
                    ...
                    <div className="space-y-8">
                        ...
                        <Controller
                            ...
                            render={({ field }) => (
                                <div className="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-900/5">
                                    <SolutionForm value={field.value} onChange={field.onChange} />
                                </div>
                            )}
                        />
                    </div>
                    ...
                    <Controller
                        ...
                        render={({ field }) => (
                            <div className="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-900/5">
                                <ResultsForm value={field.value} onChange={field.onChange} />
                            </div>
                        )}
                    />
                </div>
                ...
                <div className="space-y-8">
                    ...
                    <Controller
                        ...
                        render={({ field }) => (
                            <div className="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-900/5">
                                <TechStackForm value={field.value} onChange={field.onChange} />
                            </div>
                        )}
                    />
